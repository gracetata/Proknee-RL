...
DATA_DIR="${ROOT}/data/fullbody_v3"
MANIFEST="${DATA_DIR}/manifest.json"
OUTPUT_ROOT="${ROOT}/outputs/a100_train_v3"
RUNTIME="${ROOT}/runtime"
LOCK="${RUNTIME}/a100_train.lock"
RUNNING="${RUNTIME}/a100_train_v3.running"
COMPLETE="${RUNTIME}/a100_train_v3.complete"
FAILED="${RUNTIME}/a100_train_v3.failed"
