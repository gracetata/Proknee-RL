# Entry point for HumanoidAMPUnifiedCurriculum without editing tasks/__init__.py.
# 本文件需自带 @hydra.main（不可仅 from train import launch_rlg_hydra），否则 Hydra 无法解析 ./cfg。
# Patches isaacgym_task_map before training.

import isaacgym  # noqa: F401

from isaacgymenvs.tasks import isaacgym_task_map
from isaacgymenvs.tasks.humanoid_amp_unified_curriculum import HumanoidAMPUnifiedCurriculum

isaacgym_task_map["HumanoidAMPUnifiedCurriculum"] = HumanoidAMPUnifiedCurriculum
