...
from isaacgymenvs.tasks.humanoid_amp_unified_humanmimic import HumanoidAMPUnifiedHumanMimic

isaacgym_task_map["HumanoidAMPUnifiedHumanMimic"] = HumanoidAMPUnifiedHumanMimic
...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    from isaacgymenvs.learning import amp_models_humanmimic
    from isaacgymenvs.learning import amp_network_builder_humanmimic
    from isaacgymenvs.learning import amp_continuous_humanmimic
    import isaacgymenvs
    ...
    def build_runner(algo_observer):
        ...
        runner.algo_factory.register_builder(
            "amp_continuous_humanmimic",
            lambda **kwargs: amp_continuous_humanmimic.AMPAgentHumanMimic(**kwargs),
        )
        ...
        model_builder.register_model(
            "continuous_amp_humanmimic",
            lambda network, **kwargs: amp_models_humanmimic.ModelAMPContinuousHumanMimic(network),
        )
        model_builder.register_network(
            "amp_humanmimic",
            lambda **kwargs: amp_network_builder_humanmimic.AMPBuilderHumanMimic(),
        )
